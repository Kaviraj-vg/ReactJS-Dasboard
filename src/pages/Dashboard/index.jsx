...
import DashColumnOne from "components/DashColumnOne";

const DashboardPage = () => {
  return (
    <>
     <div className="flex sm:flex-col md:flex-col flex-row font-montserrat sm:gap-5 md:gap-5 items-center mx-auto w-full">
        <div className="bg-black_900 flex flex-col items-center justify-start p-[100px] md:px-5 w-auto md:w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start w-full ">
            <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start  w-full">
              ...
              <Img
                ...
                alt="notification"
              />
              <DashColumnOne className="flex sm:flex-1 flex-col h-[30px] items-center justify-start md:ml-[0] ml-[29px] w-[30px] sm:w-full" />
            </div>
